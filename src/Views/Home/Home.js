...
function Home()
{
    ...
    const loadNews = async () => {
       ...
       try
       {
        const response = await axios.get(`https://newsapi.org/v2/everything?q=${searchQuery}&from=2025-01-02&to=2025-01-02&sortBy=popularity&apiKey=${process.env.REACT_APP_NEWS_API}`)
