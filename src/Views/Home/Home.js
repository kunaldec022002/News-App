...
function Home()
{
    ...
    const loadNews = async () => {
       ...
       try
       {
        const response = await axios.get(`https://newsapi.org/v2/everything?q=${searchQuery}&from=2024-07-12&to=2024-07-12&sortBy=popularity&apiKey=70444052d2d2459c99023e4532137427`);
